...
class Signal:
    ...
    def __init__(self, args, intersection, sc, start_time_stamp, min_dist):
        """
        Elements:
       ...
       """
        ...
        if args.do_logging:
            filepath_sig = os.path.join(args.log_dir, "sig_level_" + str(min_dist) + ".csv")
...
class MCF_SPaT(Signal):
    ...
    def __init__(self, args, first_detection_time, intersection, sc, start_time_stamp, min_dist):
        import cplex
        """
        ...
        super().__init__(args, intersection, sc, start_time_stamp, min_dist)
