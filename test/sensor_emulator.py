...
import time
import context
from src.data_io import StoppableThread
from src.util import periodic_sleep

class SensorFusionEmulator(StoppableThread):
    """
    Utility class for emulating incoming vehicle data messages.
    Used for testing.
    """
    ...
    def run(self):
        ...
        if self._loop:
            ...
            while not self.stopped():
                self._socket.sendto(msg, (b'localhost', self._port))
